            ...
            <div class="container">
                <div class="checkout-addr">
                    ...
                    <div class="addr-list-wrap">
                        <div class="addr-list">
                            <ul>
                                <li v-for="(item,index) in addressListFilter" :key="index" :class="{'check':checkIndex === index}" @click="setParam(item,index)">
                                    <dl>
                                        <dt>{{item.userName}}</dt>
                                    ...
                                    <div class="addr-opration addr-set-default">
                                        <a href="javascript:;" class="addr-set-default-btn" v-if="!item.isDefault" @click="setDefault(item)">
                                            <i>Set default</i>
                                        </a>
                                    </div>
                    ...
                    <div class="next-btn-wrap">
                        <router-link class="btn btn--m btn--red" :to="{path:'/orderConfirm',query:{'addressId':this.selectedAddrId}}">Next</router-link>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    mounted(){
        this.init();
        //this.getAddressList().then((response) => {
